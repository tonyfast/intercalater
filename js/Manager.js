...
(function() {
  ...
  Manager = (function() {
    ...
    Manager.prototype.attach = function(selection, SelectionType, name, config) {
      ...
      if (indexOf.call(this.Selections, name) < 0) {
        this.Selections[name] = new SelectionType(selection, name, this.DataSource.tree, config);
      }
  ...
  Plot = (function(superClass) {
    ...
    function Plot(selection, name, tree, config) {
      Plot.__super__.constructor.call(this, selection, name, tree, config);
